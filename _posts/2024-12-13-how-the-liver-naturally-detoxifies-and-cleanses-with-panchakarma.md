...
seo:
    title: How the Liver Naturally Detoxifies and Cleanses with Panchakarma
    description: >-
        Discover how Ayurvedic Panchakarma detoxifies the liver naturally,
        improves digestion, and eliminates toxins. Learn safe liver cleansing
        tips for optimal health and wellbeing.
    image:
    favicon:
    index: true
